...
@section('contenido')
    <section id="Seleccion">
        ...
        <form method="POST" id="Opciones" action="{{ url('updatepregunta', [$preguntas->id]) }}">
            @csrf @method('PATCH')
            ...
            <input type="text" id="respuesta2" name="respuesta2" required autofocus autocomplete="respuesta2" value="{{ $preguntas->respuesta2 }}">
            <h3>Puntaje</h3>
            <input type="text" id="puntaje" name="puntaje" required autofocus autocomplete="puntaje" value="{{ $preguntas->puntaje }}">
            <h3>Tematica</h3>
            <select name="tematica_id" >
                <option value="{{ $preguntas->tematicas_id }}">
                    {{ $preguntas->tematica->nombre }}</option>
